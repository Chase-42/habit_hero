...
type DataKey = string | number | ((obj: unknown) => unknown);
...
>(
  (
    ...
    const typedPayload = (payload as PayloadItem[] | undefined)?.map(
      (item) => ({
        ...item,
        dataKey:
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter && typedPayload) {
        return (
